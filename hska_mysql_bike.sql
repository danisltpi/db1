...
#    1. Erzeugen Sie eine Datenbank, falls noch nicht geschehen
#       mittels des Befehls (in der Kommandozeile nach dem Start
#       von MySQL):
#                      CREATE DATABASE bike;  

#    2. Verlassen Sie MySQL und geben am Kommando-Prompt ein:
#
#                      mysql bike < hska_mysql_bike.sql
#
#       Alternativ kann unter MYSQL folgendes Kommando eingegeben
#       werden:
#                      source hska_mysql_bike.sql
#
#       Sollte die Datenbank anders lauten, so ersetzen Sie den
#       Namen 'bike' durch den entsprechenden Namen
#
# Alternativ kann diese Datei auch im MySQL-Workbench direkt
# verwendet werden
